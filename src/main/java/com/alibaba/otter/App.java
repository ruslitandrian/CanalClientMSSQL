        ...
        for (Entry entry : entrys) {
            ...
            if (eventType == EventType.QUERY || rowChage.getIsDdl()) {
                ...
                if( eventType == EventType.ERASE) {
                    MSSQLUtil.DropTable(entry, rowChage.getSql());
                }else if( eventType == EventType.RENAME){
                    MSSQLUtil.AlterTable(entry, rowChage.getSql());
                }else{
                    MSSQLUtil.CreateTable(entry, rowChage.getSql());
                }
            ...
            for (RowData rowData : rowChage.getRowDatasList()) {
                if (eventType == EventType.DELETE) {
                    MSSQLUtil.Delete(entry, rowData.getBeforeColumnsList());
                } else if (eventType == EventType.INSERT) {
                    MSSQLUtil.Insert(entry, rowData.getAfterColumnsList());
                } else {
                    MSSQLUtil.Update(entry, rowData.getAfterColumnsList());
